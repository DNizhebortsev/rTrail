...
<script>
    ...
    var RestPost = function (name, description) {
        ...
        $.ajax({
            type: 'Post',
            url: service + '/add',
            contentTypr: 'application/json:utf-8',
    ...
    <tr>
        ...
        <td>
            <form class="form-inline">
                name:<input type="text" id="pstName" value="Cat discription">
                description:<input type="text" id="'postDescription" value="Cat description">
                <button type="button" onclick="RestPost($('#postDescription').val())">try</button>
                </form>
        </td>
    </tr>
